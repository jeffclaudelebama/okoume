  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (mode === "signup") {
      ...
      if (fullName.length < 2 || password.length < 8) {
        setError("Indique un nom et un mot de passe d’au moins 8 caractères.");
